  ...
  return (
    <Layout>
      <div className="flex flex-col items-center relative z-10 bg-cyan-50">
        <div className="w-[80%] flex flex-col items-center py-12">
          <div className="w-full flex justify-center items-center gap-8 text-center">
            <span className="w-[30%] border-b border-solid border-b-gray-700"></span>
            <h2 className="text-4xl font-thin text-cyan-900">
              Građevinska firma
            </h2>
            <span className="w-[30%] border-b border-solid border-b-gray-700"></span>
          </div>
          <h1 className="m-5 text-5xl">BAJROVIĆ GROUP D.O.O.</h1>
        </div>
        <div className="w-[80%] pt-4 pb-32 flex justify-center items-center">
          <div className="w-[66%] pr-4">
            <p className="text-justify text-lg mx-2">
            ...
            <p className="text-justify text-lg mx-2 text-cyan-600">
      ...
      <div className=" w-full bg-cyan-900 pt-20 pb-8 flex justify-center items-center relative z-10">
        <img
        ...
        />
        <div className="w-1/2">
          <h1 className="text-cyan-400 ml-4 mb-4 text-3xl">
            Kvalitetno | Sigurno | Povoljno
          </h1>
          <p className="text-lg  text-gray-200 text-justify leading-2 py-2 px-4">
          ...
          <p className="text-lg  text-cyan-400 text-justify leading-2 py-2 px-4">
        ...
        <div className="w-[30%] flex justify-center">
          <div className="w-80 border border-aliceblue py-4 px-0 flex flex-col items-center text-gray-50 text-lg">
            <p>Podaci o firmi:</p>
