    ...
    <Layout>
      <div className="relative z-10 bg-cyan-50">
        <div className="py-20 flex justify-center items-center gap-10">
          ...
          <div className="w-[40%] flex justify-center py-10">
        ...
        <div class="flex flex-col items-center bg-cyan-900">
          <div class="w-[80%] pt-20 text-cyan-600 flex justify-center items-center gap-6">
          ...
          <div class="w-[80%] py-8 grid gap-8 grid-cols-3">
            <div
