...
const Headline = () => {
  return (
    <div className="py-8 bg-cyan-900 flex flex-col items-center">
      ...
      <div className="my-6 text-center text-lg w-2/3 text-gray-400">
        <p>
      ...
      <div className="my-6 w-2/3 flex justify-evenly">
        <button className="py-4 px-8 w-4/12 border-0 bg-cyan-700 text-white text-md font-body  transition-all hover:bg-cyan-400">
          STANOVI U PONUDI
        </button>
        <button className="py-4 px-8 w-4/12 border-0 bg-cyan-700 text-white text-md font-body  transition-all hover:bg-cyan-400">
          OPŠIRNIJE O NAMA
