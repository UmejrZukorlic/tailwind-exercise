  ...
  return (
    <Layout>
      <div>
        ...
        <div className="py-20 flex md:flex-row flex-col justify-center items-center relative z-10 bkg">
          ...
          <div
            ...
            <form
              ...
              <button
                className="mr-4 w-full text-lg p-2 border-none bg-teal-900 text-white cursor-pointer transition-all"
                type="submit">
                POŠALJI
              </button>
            </form>
