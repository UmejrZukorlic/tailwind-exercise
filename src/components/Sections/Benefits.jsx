      ...
      <div className="relatve pt-20 flex flex-col items-center bkg">
        <div className="w-[80%] flex flex-col md:flex-row gap-4 md:gap-0 justify-evenly items-center">
          ...
          <div className="w-4/5 md:w-[35%] text-black text-center ">
            <h3 className="text-teal-600 text-2xl font-thin ">KVALITETNO</h3>
            <p>
          ...
          <div className="w-4/5 md:w-[35%] text-black text-center ">
            <h3 className="text-teal-600 text-2xl font-thin">POVOLJNO</h3>
            <p>
        ...
        <div className="py-20 text-center">
          <h1 className=" text-3xl font-thin">
            Do danas, <span className="text-teal-600"> preko 4300</span> ljudi
